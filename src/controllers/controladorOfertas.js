...
const crearOferta = async (req, res) => {
    ...
    try {
        ...
        await usuario.save()
        const ofertaPop = await ModeloOfertas.findById(nuevaOferta._id).populate('nombre apellido email f_perfil monedasTrabajos')
...
const listarOfertas = async (req, res) => {
    try {
        const ofertas = await ModeloOfertas.find().populate('proveedor', 'nombre apellido email f_perfil monedasTrabajos');
